...
def hawkins_window(H, size, N, P, R, C, B, current_state, gamma=0.95):
    # B: per step budget
    ...
    actions_window, L, Q, lambda_val, Q_vals_per_state = hawkins_actions.get_hawkins_actions(H, N, Psize, R, costs, B, current_state, gamma)
