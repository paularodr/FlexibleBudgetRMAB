...
def lp_phase1(T, R, C, B, start_state, lambda_lim=None, gamma=0.95):
	...
	# Create a new model
	m = Model("LP for Computing two-step budget constraint indexes in pahse 1")
	m.setParam( 'OutputFlag', False )

	L = np.zeros((NPROCS,NSTATES,NBUDGETSTEP),dtype=object)
